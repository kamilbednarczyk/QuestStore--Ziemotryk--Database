...
public class FileUploaderService {
     ...
     */
    public void upload(HttpExchange exchange, String imagesSubFolderName) throws IOException {
        ...
        try {
            while (!allRead) {
                ...
                writeByteArrayTofile(file.data, file.fileName, imagesSubFolderName);
            }
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
    ...
    private void writeByteArrayTofile(byte[] bytes, String fileName, String imagesSubFolderName) {
        try (FileOutputStream stream = new FileOutputStream("src/main/resources/static/IMAGES/"+imagesSubFolderName+"/"+fileName)) {
            stream.write(bytes);
